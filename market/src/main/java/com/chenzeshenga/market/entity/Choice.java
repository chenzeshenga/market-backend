...
public class Choice {
	...
	public int getProdplace() {
		return prodplace;
	}

	public void setProdplace(int prodplace) {
	...
	public String getChoicepic() {
		return choicepic;
	}

	public void setChoicepic(String choicepic) {
	...
	public String getGuideroyalty() {
		return guideroyalty;
	}

	public void setGuideroyalty(String guideroyalty) {
		this.guideroyalty = guideroyalty;
	}
